            ...
            createElement('nav', {},
                ...
                createElement('div', { className: 'left-side' }, 
                    createElement('a', { href: 'notification' }, 
                        createElement('i', { className: 'fa-regular fa-bell icon', 'aria-hidden': 'false' })),
                    createElement('a', { href: 'settings' }, 
                        createElement('i', { className: 'fa-solid fa-sliders icon', 'aria-hidden': 'false' })),
                    createElement('a', { href: 'login' }, 
                        createElement('i', { className: 'fa-solid fa-arrow-right-from-bracket icon', 'aria-hidden': 'false' })
                    )
                )
            )
        );
