...
class leaderboard extends HTMLElement
{
    ...
    render()
    {
        const virtualDom = createElement('div', { className: 'winners' }, 
        ...
        const container = document.getElementsByClassName('leader-board')[0];
...
window.customElements.define('leaderboard-component', leaderboard);
