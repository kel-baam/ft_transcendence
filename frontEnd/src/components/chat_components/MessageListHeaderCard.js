...
class MessageListHeaderCard
{
    ...
    render()
    {
        const MessageListHeader =
            createElement('div', { className: 'header', style: 'gap: 15px; display: grid;'},
                ...
                createElement('div', { className: 'more-info'},
                    createElement('a', { className: 'fa-solid fa-ellipsis-vertical icon', style: 'display: none;'})
                )
            )
...
export default MessageListHeaderCard;