            ...
            if header_name == b'cookie':
                ...
                try:
                    ...
                    if user:
                        ...
                        #     self.group_name = f"tournament_{self.tournament_id}" #notif
...
# ------------------------------------------PVP----------------------------
    ...
    @database_sync_to_async #changed
    ...
    async def update_tournament_hierarchy(self, tournament, matches):
        ...
        try:
            ...
            for index, match in enumerate(matches):
                if match.status == "completed" or match.status == 'exited':
                    if tournament.mode == "local" and match.status == 'completed':
                        print("---> in local")
                        winner = await self.determine_winner(match)
                    # else:
                    #     print("hna")
...
#             if match and match.room_name: #added for if match exist 
...
#     async def broadcast_winners(self, event):
#         print("here broadcast_winners ------------------------------------")
#         print("-------------> event : ", event)
...
#             'tournament_status' : event["tournament_status"]
#         })

#     # async def first_match_broadcast(self, event):
#     #     print("here first_match_broadcast ------------------------------------")
#     #     print("-------------> event : ", event)
