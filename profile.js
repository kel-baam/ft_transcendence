document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if(friendsButton)
    {
        friendsButton.addEventListener("click",()=>
        {
            ...
            friendAndReqScop.querySelector(".view-all-link-fr").style.display="flex";
    ...
    const friendAndReqScop=document.querySelector(".friends-and-requetes-container");
    ...
    if(pendingButton)
    {
        pendingButton.addEventListener("click",()=>
        {
            ...
            document.querySelector(".requestes-items").style.display="none";
            friendAndReqScop.querySelector(".view-all-link-fr").style.display="none";
