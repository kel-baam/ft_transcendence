...
export const MessageList = defineComponent(
    {
        ...
        render()
        {
            ...
            console.log("data 1-----", JSON.stringify(realTimeMsg, null, 2))
            console.log("data 3-----", newMsg)
            ...
            if (realTimeMsg && realTimeMsg.length > 0 && !newMsg) {
                ...
                if (uniqueMessages.length > 0) {
                    const updatedMessages = [...all_stored_msg, ...uniqueMessages];
                    this.updateState({ 
                ...
                console.log("data -----", JSON.stringify(updatedMessages, null, 2))
                }
            }
            ...
            const data = [
                {
                    ...
                    room: "walkerbarbara_joshuabrown",
                    content: "salut",
                    read: false,
