                        ...
                        h('div', { class: 'round1' }, 
                            (this.state.matcheRounds || []).map((match, i) =>
                                h('div', { class: `match${i + 1}` }, [
                                    h('div', { class: 'player1' }, [
                                        h('img', { 
                                            src: match.avatar1 ? `http://localhost:8000${match.avatar1}` : './images/people_14024721.png'
                                        }),
                                        h('h2', {}, [match.player1])
                                    ]),
                                    h('div', { class: 'vs' }, [
                                    ...
                                    h('div', { class: 'player2' }, [
                                        h('img', { 
                                            src: match.avatar2 ? `http://localhost:8000${match.avatar2}` : './images/people_14024721.png'
                                        }),
                                        h('h2', {}, [match.player2])
                                    ])
                                ])
